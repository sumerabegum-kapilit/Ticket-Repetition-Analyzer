...
SYSTEM_PROMPT = (
    ...
    "The CONTEXT has two parts: precomputed dataset-wide statistics (use these for any "
    "total/count/percentage/trend/top-N question - they cover the whole dataset) and a "
    "sample of individual tickets most relevant to the question (use these for examples, "
    "detail, or anything the statistics don't cover - never treat this sample's size as the "
    "dataset total). "
